    ...
    <div className={styles.formWrapper}>
      <form onSubmit={handleSubmit(onSubmitForm)} className={styles.formInputs}>
        <div className={styles.formHeader}>
          ...
          <p>
            Podaj swoje dane kontaktowe, następnie wybierz model auta oraz salon
            w którym chciałbyś odbyć jazdę próbną. Nasz konsultant skontaktuje
            się z Tobą, aby wybrać dogodny dla Ciebie termin.{" "}
          </p>
        </div>
